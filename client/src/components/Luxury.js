...
const Luxury = ({ luxury }) => {
  ...
  return (
    <div className="lux-contain">
      <div className="stock-desc">
        <span className="stock-name">{luxury.stockName}: $
        {luxury.stockPrice * luxury.multiplier}</span>
        <br />
        {luxury.stockDescription}
      </div>
      <div className="manageStock">
        ...
        <div className="manageStockButton">
          <button onClick={buyClick} data-id={luxury._id}>
            Buy
          </button>
          <button onClick={sellClick} data-id={luxury._id}>
            Sell
          </button>
        </div>
      </div>
